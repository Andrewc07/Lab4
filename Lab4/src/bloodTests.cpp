...
void hormoneLevels::show(){

	if (testPerformed==1){
		cout<<"Hormone Levels: "<< endl;
		cout<<endl<<"Testosterone: "<< testosterone << endl;
		cout<<endl<<"Cortisol: "<< cortisol << endl;
		cout<<endl<<"DHEA: "<< dhea << endl;
	}
}
...
void bloodSugar::show(){

	if(testPerformed==1){
		cout<<endl<<"Glucose: "<<glucose<<endl;
		cout<<endl<<"Insulin: "<<insulin<<endl;
	}
}
